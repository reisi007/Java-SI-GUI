...
public enum MainUiTranslation implements TranslationKey {
    APP_NAME, TAB, DOWNLOAD_UPDATE, INSTALLER_MAIN, INSTALLER_HELP, INSTALLER_SDK, INSTALLER_LANGPACK, DOWNLOAD_START, AVAILABLE_LANGUAGES, OPEN, INSTALL_START, FINDINSTALLATIONS, SHORTCUT_CREATE, MANAGER_DELETE, CREDITS, MANAGER_TABLE_KEY, MANAGER_TABLE_VALUE;
